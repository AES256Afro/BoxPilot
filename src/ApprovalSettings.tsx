...
export default function ApprovalSettings({ csrfToken }: { csrfToken: string }) {
  ...
  return (
    <section className="panel settings-panel">
      <header className="panel-header"><div><strong>Approvals</strong><span>How much BoxPilot asks before it changes this server</span></div>{mode && <span className="status-pill status-neutral">{mode === "tiered" ? "Tiered" : "Always ask"}</span>}</header>
