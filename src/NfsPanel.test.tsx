...
const base = { installed: true, running: true, configured: true, error: null, config: { managed: true, scope: "tailscale", exports: [{ path: "/srv/media", readOnly: true, clients: ["100.64.0.0/10"] }] }, tailscaleDnsName: "bigbox.tail1234.ts.net", tailscaleAddress: "100.64.0.5", lanAddress: "192.168.1.10" };
...
describe("NFS panel", () => {
  ...
  it("shows exports with mount hints and applies an edited list with LAN scope", async () => {
    ...
    expect(screen.getByText(/nfs:\/\/bigbox\.tail1234\.ts\.net\/srv\/media/)).toBeTruthy();
