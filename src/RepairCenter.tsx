...
interface RecoveryKit {
  ...
  evidence: { jobs: unknown[]; controllerBackups: unknown[]; controllerProtections?: unknown[]; applicationBackups: unknown[]; vmBackups: unknown[]; routerCheckpoints: unknown[]; migrationTransfers: unknown[]; fleet: { activeAgents: number; revokedAgents: number } };
