...
- Console proxy, online snapshot, snapshot revert/delete, isolated restore, protected VM status, restore execution, retention mutation, Windows TPM/Secure Boot, and cloud-init remain pending
