...
- Console proxy, online snapshot, snapshot revert/delete, operator-directed restore execution, application-level restore tests, retention mutation, Windows TPM/Secure Boot creation, and cloud-init remain pending
