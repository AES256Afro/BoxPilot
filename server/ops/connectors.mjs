...
export function connectorOperations() {
  return [
    ...
    defineOperation({
      id: "credentials.inspect", title: "List saved credentials", risk: "low", readOnly: true, timeoutMs: 30_000,
    ...
    defineOperation({
      id: "http.request", title: "Send an HTTP request", risk: "medium", timeoutMs: minutes(2),
      description: "Sends one request from this server: a webhook, an ntfy push, an API call. A saved credential can ride along by name in a header of your choosing; the response's status, body, and parsed JSON become the result, which later automation steps can read. Sent from this server under your account.",
      parameters: { fields: {
        ...
        contentType: { type: "string", optional: true, maxLength: 120 },
        ...
        credentialPrefix: { type: "string", optional: true, maxLength: 40 },
      } },
