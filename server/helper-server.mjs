...
const helperDependencies = { applications, applicationProtection, controllerBackups, controllerProtection, controllerRetention, keelDiscovery, keelArtifacts, keelArchive, keelStage, keelInstall, keelBackups, keelRecovery, keelRecoveryDrill, keelPromotion, migrations, prerequisites, vmRestoreDrill, vmRecovery, vmRetention };
...
server.listen(socketPath, async () => {
  ...
  console.log(`BoxPilot helper 0.51.0 listening on ${socketPath}`);
});
