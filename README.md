...
| **App catalog** | Install, configure, update, back up, restore, and uninstall 24 self-hosted apps from YAML manifests — Jellyfin, Home Assistant, Vaultwarden, Forgejo, Portainer, Grafana, Paperless-ngx, n8n, Pi-hole (with a blocklist picker), AdGuard Home, Scrutiny disk health, File Browser, and more. Live status, logs, resource use, one-click HTTPS on your tailnet. |
